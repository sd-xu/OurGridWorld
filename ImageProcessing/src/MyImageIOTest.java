...
//    standardImg = ImageIO.read(new File("../bmptest/1.bmp"));
    filePath = "ImageProcessing/bmptest/1.bmp";
    standardImg = ImageIO.read(new File(filePath));
  }

  /**
   * Test method for {@link MyImageIO#myRead(String)}.
   */
  @Test
  ...
  /**
   * Test method for {@link MyImageIO#myWrite(Image, String)}
   */
  @Test
  public void testMyWrite() {
    Image img2 = imageIOer.myWrite(standardImg, "ImageProcessing/bmptest/1.bmp");
